...
#let cv(
  ...
  let st = (
    (
      ...
      summary: "Travaillons ensemble !",
      motivation: "MOTIVATION",
      experience: "Ce que j'ai fait jusque là",
      education: "Formation",
  ...
  let main-renderers = (
    summary: () => {
      text-block("cv-interatif", align(right,emph(text(12pt, [Retrouvez mon CV interatif sur #text(weight: "bold", green, "delagnier.fr")]))))
      if summary != none {
